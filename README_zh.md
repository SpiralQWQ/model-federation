...
<details>
<summary><b>Q: 怎么确认部署成功？</b></summary>
在 Claude Code 中问一个技术问题。观察：(1) <code>Intent_Sniffer</code> YAML，(2) <code>🔗 [双引擎协同]</code> 日志，(3) 模型协同日志/ 下新增的 <code>.md</code> 文件。
</details>
...
├── CLAUDE.template.md            (553行) AI 行为规则模板
├── settings.template.json        (10把Key) 环境变量模板
